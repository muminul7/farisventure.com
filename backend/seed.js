...
if (dealCount === 0) {
  ...
  const deals = [
    { sector: 'Service', structure: 'Murabaha', structureBn: 'মুরাবাহা', status: 'Deployed', amountEn: 'BDT 5 lakh', amountBn: '৳৫ লাখ', nameEn: 'SukunLife', nameBn: 'SukunLife', descEn: 'A service-sector business, Murabaha financed for steel materials', descBn: 'একটা সার্ভিস-সেক্টর বিজনেস, স্টিল মেটেরিয়ালসের জন্য মুরাবাহায় অর্থায়ন করা', roi: null,
      overviewEn: 'SukunLife is a service-sector business and the first deal funded under this SME segment. The Murabaha financed a steel materials purchase, deployed in July 2026 with a 6-month term and a confirmed profit rate agreed before disbursement.',
      overviewBn: 'SukunLife একটা সার্ভিস-সেক্টর বিজনেস, আর এই SME সেগমেন্টের আওতায় ফান্ড হওয়া প্রথম ডিল। মুরাবাহাটা গেছে একটা স্টিল মেটেরিয়ালস কেনার খরচ মেটাতে। বিতরণ হয়েছে ২০২৬-এর জুলাইয়ে, ৬ মাস মেয়াদে, বিতরণের আগেই ঠিক করা একটা নিশ্চিত মুনাফার হার নিয়ে।',
      useEn: 'Capital was deployed under a Murabaha structure to finance a steel materials purchase, secured with a post-dated cheque and a defined repayment schedule agreed before disbursement.',
      useBn: 'স্টিল মেটেরিয়ালস কেনার খরচ মেটাতে মুরাবাহা কাঠামোর আওতায় পুঁজি গেছে। নিরাপত্তা হিসেবে আছে post-dated চেক, আর বিতরণের আগেই ঠিক করা একটা পরিশোধের সময়সূচি।', sortOrder: 1 },
